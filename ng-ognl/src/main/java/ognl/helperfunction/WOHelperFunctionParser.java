...
public class WOHelperFunctionParser {
	...
	public WOHelperFunctionParser( String htmlString, String declarationString, List languages ) {
	...
	public NGElement parse() throws WOHelperFunctionDeclarationFormatException, WOHelperFunctionHTMLFormatException, ClassNotFoundException {
		parseDeclarations();
	...
	public void setDeclarations( Map value ) {
		_declarations = value;
	}
	...
	public static NGDeclaration createDeclaration( String declarationName, String declarationType, Map associations ) {
