...
public class WOHelperFunctionDeclarationParser {
	...
	private Map<String, String> _quotedStrings;
	...
	public static Map<String, String> declarationsWithString( String declarationStr ) throws WOHelperFunctionDeclarationFormatException {
		WOHelperFunctionDeclarationParser declarationParser = new WOHelperFunctionDeclarationParser();
		Map<String, String> declarations = declarationParser.parseDeclarations( declarationStr );
		return declarations;
	}
	...
	public Map<String, String> parseDeclarations( String declarationStr ) throws WOHelperFunctionDeclarationFormatException {
		...
		Map<String, String> declarations = parseDeclarationsWithoutComments( strWithoutComments );
		return declarations;
	}
	...
	private Map<String, String> parseDeclarationsWithoutComments( String declarationWithoutComment ) throws WOHelperFunctionDeclarationFormatException {
		Map<String, String> declarations = new HashMap<>();
		Map<String, String> rawDeclarations = _rawDeclarationsWithoutComment( declarationWithoutComment );
		String tagName;
