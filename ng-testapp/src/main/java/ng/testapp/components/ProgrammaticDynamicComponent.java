...
public class ProgrammaticDynamicComponent extends NGComponent {
	...
	public NGElement template() {
		...
		g._children.add( new NGStylesheet( "wat?", stylesheet, null ) );

		g._children.add( new NGHTMLBareString( "</head>\n" ) );
		g._children.add( new NGHTMLBareString( "<body>\n" ) );

		g._children.add( new NGHTMLBareString( "<h2>This is a programmatically generated component template</h2>\n" ) );
		...
		g._children.add( new NGImage( "wat?", image1, null ) );

		g._children.add( new NGHTMLBareString( "<br><br>" ) );
		...
		g._children.add( new NGImage( "wat?", image2, null ) );
		...
		g._children.add( new NGImage( "wat?", image3, null ) );
